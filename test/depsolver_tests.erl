...
integration_test() ->
      World = {depsolver, {26, {<<"users">>, [{{{1,0,0},{[],[]}},[]}],
                                   {<<"openssl">>, [{{{1,0,0},{[],[]}},[]}, {{{0,1,0},{[],[]}},[]}],
                                       {<<"macbook">>, [{{{0,1,0},{[],[]}},[]}, {{{0,0,0},{[],[]}},[]}],
                                           {<<"java_sun">>, [{{{0,10,0},{[],[]}}, [{<<"java">>, {{0,0,0},{[],[]}}, '>='}]}],
                                               {<<"dbapp">>, [{{{0,1,0},{[],[]}},[]}],
                                                   {<<"build-essential">>, [{{{1,0,2},{[],[]}},[]}],
                                                       {<<"aws">>, [{{{0,9,0},{[],[]}},[]}],
                                                           {<<"apt">>, [{{{1,10,0},{[],[]}},[]}],
                                                           {<<"apache2">>, [{{{1,6,2},{[],[]}},[]}], nil,nil}, nil}, nil},
                                                       {<<"chef_handler">>, [{{{1,0,6},{[],[]}},[]}], nil,nil}},
                                                   {<<"edb_demo">>, [{{{0,0,1},{[],[]}},[]}],
                                                   {<<"dbserver">>, [{{{0,1,0},{[],[]}},[]}], nil,nil},
                                                   {<<"java">>, [{{{1,1,0},{[],[]}}, [{<<"apt">>, {{0,0,0},{[],[]}}, '>='}]}], nil,nil}}},
                                               {<<"jpackage">>, [{{{0,10,0},{[],[]}}, [{<<"java">>, {{0,0,0},{[],[]}}, '>='}]}], nil,nil}},
                                           {<<"networking_basic">>, [{{{0,0,5},{[],[]}},[]}],
                                           {<<"mysql">>, [{{{1,2,6},{[],[]}}, [{<<"windows">>, {{0,0,0},{[],[]}}, '>='},
                                           {<<"openssl">>, {{0,0,0},{[],[]}}, '>='}]},
                                           {{{1,0,2},{[],[]}}, [{<<"openssl">>, {{0,0,0},{[],[]}}, '>='}]},
                                           {{{0,24,4},{[],[]}}, [{<<"openssl">>, {{0,0,0},{[],[]}}, '>='}]}], nil,nil},
                                           {<<"ntp">>, [{{{1,0,0},{[],[]}},[]}], nil,nil}}},
                                   ...
                                   {<<"wordpress">>, [{{{0,8,8},{[],[]}}, [{<<"php">>, {{0,0,0},{[],[]}}, '>='},
                                   {<<"mysql">>, {{1,0,5},{[],[]}}, '>='},
                                   {<<"openssl">>, {{0,0,0},{[],[]}}, '>='},
                                   {<<"apache2">>, {{0,99,4},{[],[]}}, '>='}]}],
                                   {<<"windows">>, [{{{1,3,0},{[],[]}}, [{<<"chef_handler">>, {{0,0,0},{[],[]}}, '>='}]}], nil,nil},
                                   {<<"xml">>, [{{{1,0,2},{[],[]}},[]}], nil,nil}}}
                          }
              },
      Ret = depsolver:solve(World, [<<"testcb">>]),
      ?assertMatch({ok,[{<<"testcb">>,{{0,1,1},{[],[]}}}]}, Ret).


should_exist_test() ->
    Constraints = [{<<"foo">>,[{<<"1.2.3">>, [{<<"bar">>, <<"2.0.0">>, gt}]}, {<<"1.3.5">>, []}]}],
    World = depsolver:add_packages(depsolver:new_graph(), Constraints),
    Ret = depsolver:solve(World, [<<"foo">>]),
    ?assertMatch({ok,[{<<"foo">>,{{1,3,5},{[],[]}}}]}, Ret).
